...
exports.default = { RECEIVE_TODO: RECEIVE_TODO, RECEIVE_TODOS: RECEIVE_TODOS, receiveTodo: receiveTodo, receiveTodos: receiveTodos };
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(16), __webpack_require__(75)(module)))
...
var rootReducer = (0, _redux.combineReducers)({ todos: _todos_reducer2.default });
...
var _todo_actions = __webpack_require__(35);
...
var todosReducer = function todosReducer() {
  ...
  switch (action.type) {
    case _todo_actions.RECEIVE_TODO:
      var todo = _defineProperty({}, action.todo.id, action.todo);
      var newState = (0, _merge2.default)({}, state, todo);
      return newState;
...
function allTodos(state) {
  ...
  var todos = Object.keys(state.todos).map(function (key) {
    return _defineProperty({}, key, state.todos[key]);
  });
  // debugger;
...
var mapStateToProps = function mapStateToProps(state) {
  return { todos: (0, _selectors.allTodos)(state) };
};
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.todos.map(function (el) {
            // console.log(el);
            // debugger;
            return _react2.default.createElement(_todo_list_item2.default, { item: el });
          })
        )
      );
    }
